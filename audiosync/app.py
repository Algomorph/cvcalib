...
class SyncVideoApp(object):
    ...
    def __init__(self, args):
        ...
        self.args = args
        if not args.calculate_offset_only and args.output[0] is None:
    ...
    def run_sync(self):
        ...
        if args.calibration_clip:
            frame_ranges, time_ranges = find_calibration_conversion_range(args.videos, args.folder, self.offset,
                                                                          self.board_dims,
